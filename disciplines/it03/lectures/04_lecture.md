...
::: quiz source=./includes/quiz-04.yaml
:::

## Практические задания

### Задание 1. SELECT * — вывод всей таблицы
...
### Задание 2. SELECT для отдельных столбцов
...
### Задание 3. WHERE по условию наличия остатка
...
### Задание 4. WHERE с условием «меньше» по числовому полю
...
### Задание 5. WHERE с условием «больше или равно» по числовому полю
...
### Задание 6. AS — переименование столбцов в выдаче
