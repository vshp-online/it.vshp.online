...
::: quiz source=./includes/quiz-07.yaml
:::

## Практические задания

### Задание 1. `SUM` + `COUNT` — сводные показатели по таблице
...
### Задание 2. `DISTINCT` + подсчёт количества уникальных значений
...
### Задание 3. `GROUP BY` + `ORDER BY` — рейтинг групп по сумме
...
### Задание 4. `AVG` + `COUNT` — средние и количество по группам
...
### Задание 5. `HAVING` — отбор групп с пороговым значением
...
### Задание 6. `HAVING` с несколькими условиями по заказам и объёму
