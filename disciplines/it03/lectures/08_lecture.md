...
### Задание 1. `INSERT` — добавляем одну запись
...
### Задание 2. `INSERT` нескольких строк в одном запросе
...
### Задание 3. `UPDATE` — изменение цены и остатка по формуле
...
### Задание 4. `UPDATE` — массовое обновление по условию
...
### Задание 5. `DELETE` — удаление по артикулу
...
### Задание 6. `DELETE` — удаление по нескольким условиям
