...
1. Используйте скрипт: `yarn post:create "Заголовок новости"`.
2. Будет создан файл `blog/YYYY-MM-DD-HH-MM.md` с московским временем в названии и базовым frontmatter `tags: []`.
3. Откройте файл, дополните теги и содержимое.
4. После сохранения при следующем `yarn dev`/`yarn build` плагин блога обновит `public/data/blog-posts.json`, а страница блога подхватит новую запись.
